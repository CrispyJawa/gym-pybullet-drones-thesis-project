...
if __name__ == '__main__':
    edges =  (0, 1), (1, 2), (0, 3), (0, 7), (1, 6), (2, 5), (3, 4), (4, 5) #(0, 1), (1, 2), (2, 3)
    print("Graph")
    g = Graph(edges, 8, 0)
    g.print_graph()
    ...
    check_array = np.zeros(g.get_size(), int)
    print("Nodes connected to each other through the swarm:", g.find_ultimate_links(g.get_head(), check_array))
    ...
    g.delete_edge(1,2)
    check_array = np.zeros(g.get_size(), int)
    print("check array again", g.find_ultimate_links(g.get_head(), check_array))
